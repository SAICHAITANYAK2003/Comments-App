...
class Comments extends Component {
  ...
  onAddComment = event => {
    ...
    const initialContainerBackgroundClassNamesdata = `initial-container ${
    ...
    const addNewComment = {
      ...
      date: new Date(),
      isLiked: false,
      initalClassName: initialContainerBackgroundClassNamesdata,
    }
    this.setState(prevState => ({
      commentsList: [...prevState.commentsList, addNewComment],
      nameInput: '',
      commentInput: '',
    }))
  }
